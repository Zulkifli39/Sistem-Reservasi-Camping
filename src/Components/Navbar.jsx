...
import {FaQrcode, FaAlignCenter, FaRegNewspaper, FaAlignLeft, FaUser} from "react-icons/fa";
      ...
      <aside
        ...
        <div className="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
          <ul className="space-y-2 font-medium">
            <li>
              <a href="/admin/dashboard" className={getNavLinkClass("/admin/dashboard")}>
                <FaQrcode />
                <span className="ms-3">Dashboard</span>
              </a>
            </li>
            <li>
              <a href="/admin/kategori" className={getNavLinkClass("/admin/kategori")}>
                <FaAlignCenter />
                <span className="ms-3">Kategori</span>
              </a>
            </li>
            <li>
              <a href="/admin/berita" className={getNavLinkClass("/admin/berita")}>
                <FaRegNewspaper />
                <span className="ms-3">Berita</span>
              </a>
            </li>
            <li>
              <a href="/admin/users" className={getNavLinkClass("/admin/users")}>
                <FaUser />
