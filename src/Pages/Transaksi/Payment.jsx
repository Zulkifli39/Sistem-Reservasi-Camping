...
const Payment = ({totalAmount, onPaymentSuccess, onPaymentCancel, formData}) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
      <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-lg">
        <h1 className="text-2xl font-bold mb-6 text-center">Informasi Pembayaran</h1>
        ...
        {/* Total Harga */}
        <p className="text-lg mb-4">Total Pembayaran: Rp. {totalAmount.toLocaleString()}</p>
