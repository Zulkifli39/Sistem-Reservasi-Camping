  ...
  return (
    <>
      <div className="bg-white w-full">
        <footer className="footer bg-base-200 text-base-content p-6 md:p-10 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <footer className="footer bg-base-200 text-base-content border-t border-base-300 p-6 md:flex md:items-center md:justify-between">
