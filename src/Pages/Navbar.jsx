        ...
        <div className="flex md:order-2 items-center space-x-3 rtl:space-x-reverse">
          {userName ? (
            <div className="flex items-center space-x-4">
              ...
              <button
                onClick={handleLogout}
                className="hidden md:inline-block text-white bg-red-600 hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-red-500 dark:hover:bg-red-600 dark:focus:ring-red-700">
                Logout
              </button>
            </div>
          ) : (
