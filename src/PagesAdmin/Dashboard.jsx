const Dashboard = () => {
  return (
    <main className="w-full  h-full pb-16 ">
      ...
      <div className="ml-0 md:ml-96  grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4">
        <div className="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
          ...
          <div>
            <p className="mb-2 text-sm font-medium text-gray-600 dark:text-gray-400">Total Products</p>
        ...
        <div className="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
          ...
          <div>
            <p className="mb-2 text-sm font-medium text-gray-600 dark:text-gray-400">Total Reservasi</p>
        ...
        <div className="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
          ...
          <div>
            <p className="mb-2 text-sm font-medium text-gray-600 dark:text-gray-400">Total User</p>
